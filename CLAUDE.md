...
This project is indexed by GitNexus as **ForagerFlow** (1253 symbols, 2602 relationships, 107 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
