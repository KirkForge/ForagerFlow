...
This project is indexed by GitNexus as **ForagerFlow** (1700 symbols, 4055 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
