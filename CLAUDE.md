...
This project is indexed by GitNexus as **ForagerFlow** (1412 symbols, 2994 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
