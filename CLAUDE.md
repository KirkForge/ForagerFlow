...
This project is indexed by GitNexus as **ForagerFlow** (1316 symbols, 2732 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
