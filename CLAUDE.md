...
This project is indexed by GitNexus as **ForagerFlow** (1469 symbols, 3216 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
