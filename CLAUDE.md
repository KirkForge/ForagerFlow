...
This project is indexed by GitNexus as **ForagerFlow** (1427 symbols, 3044 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
