...
This project is indexed by GitNexus as **ForagerFlow** (1741 symbols, 4182 relationships, 143 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
