...
This project is indexed by GitNexus as **ForagerFlow** (1384 symbols, 2899 relationships, 118 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
