...
This project is indexed by GitNexus as **ForagerFlow** (1332 symbols, 2742 relationships, 111 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
